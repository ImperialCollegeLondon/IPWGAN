...
if torch.cuda.is_available() and opt.cuda:
    print("WARNING: You have a CUDA device, you are running with --cuda")
...
for seed in range(43, 44):
    ...
    netG = WGANFPN.LaplacianPyramidGenerator(opt.imageSize, nz, nc, ngf, ngpu)
    print("netG init end.")
    ...
    save_hdf5(fake.data, 'SimonIWbiggest{1}_{2}.hdf5'.format(opt.experiment, opt.experiment, seed))
